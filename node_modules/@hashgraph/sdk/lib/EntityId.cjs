  ...
  constructor(props, realm, num) {
    if (typeof props === "number" || props instanceof _long.default) {
      if (realm == null) {
        ...
        this.num = _long.default.fromValue(props);
      } else {
        this.shard = _long.default.fromValue(props);
        this.realm = _long.default.fromValue(realm);
        this.num = num != null ? _long.default.fromValue(num) : _long.default.ZERO;
      }
    } else {
      this.shard = _long.default.fromValue(props.shard != null ? props.shard : 0);
      this.realm = _long.default.fromValue(props.realm != null ? props.realm : 0);
      this.num = _long.default.fromValue(props.num != null ? props.num : 0);
    }
  }
  /**
   * @abstract
