 ...
 * @template ValueT
 */
export default class ObjectMap<KeyT extends import("../EntityId.js").default<any>, ValueT> {
    /**
     ...
     * @returns {?ValueT}
     */
    get(key: string | KeyT): ValueT | null;
    /**
     * @internal
     * @param {KeyT} key
     * @param {ValueT} value
 ...
 * <T>
 */
export type EntityId<T> = import("../EntityId.js").default<T>;
