...
class TokenCreateTransaction extends _Transaction.default {
  ...
  constructor(props = {}) {
    ...
    this._expirationTime = _Timestamp.default.fromDate(Date.now() + _Transaction.DEFAULT_AUTO_RENEW_PERIOD.toInt());
    /**
     * @private
     * @type {Duration}
     */
  ...
  _makeTransactionData() {
    return {
      ...
      autoRenewPeriod: this._autoRenewPeriod != null ? this.autoRenewPeriod._toProtobuf() : null
    };
  }
